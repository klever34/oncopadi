...
import {colors, symptoms_gray, symptoms_purple} from '../../../constants/index';
  ...
  render() {
    ...
    return (
      <View style={{flex: 1, backgroundColor: '#F8F6FE'}}>
        <Header title={'Symptoms'} selectedIcon={iconSelected} />
        <View style={{flex: 1}}>
          <TouchableOpacity
          ...
          {data.length <= 0 && (
            <View
              ...
              <View style={{marginVertical: 20}}>
                <SvgXml width="30" height="40" xml={symptoms_gray} />
              </View>
        ...
        <Modal
          ...
          <View style={{flex: 1, padding: 20}}>
            ...
            <View style={{alignItems: 'center'}}>
              <Text style={[styles.addText, {fontFamily: 'Poppins-Bold'}]}>
                Add Symptom
              </Text>
            </View>
            <Text style={styles.smallText}>Symptoms</Text>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.smallText}>When did you feel it?</Text>
              <AntDesign
                name={'down'}
                color={colors.primary}
            ...
            <View style={styles.btmContainer}>
              <TouchableOpacity
                ...
                onPress={() => authUser()}>
                <Text style={styles.smallLogin}>Add</Text>
                {showIndicator && (
                  <ActivityIndicator
                    size="small"
                    color="#ffffff"
